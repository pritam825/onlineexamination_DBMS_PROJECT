...
<div class="col-md-10">
<a href="mailto:ayushman.mishra9@gmail.com" style="color:#000000"><ul><li>baibhav200000@gmail.com</li> or <li>ayushman.mishra9@gmail.com</li></ul></a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="baibhav" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/donnieboiii" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">BAIBHAV AND AYUSHMAN</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9801391353</h4>
		<h4 style="font-family:'typo' ">baibhav200000@gmail.com</h4>
		<h4 style="font-family:'typo' ">Delhi Technological University - New Delhi</h4></div></div>
		</p>
      </div>
